...
for ( i in jobData.hits){
    ...
    console.log(`Location: \n- ${jobData.hits[i].locations[0]}`)
    console.log('Benefits:')
    for (j in jobData.hits[i].benefits){
        console.log(`- ${jobData.hits[i].benefits[j].benefitValue}`)
    }
    console.log('Skills')
    for (k in jobData.hits[i].skills){
        console.log(`- ${jobData.hits[i].skills[k]}`)
    }
console.log('----------------------------------------------------------------------')
}
